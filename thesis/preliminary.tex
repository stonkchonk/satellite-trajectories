...
\begin{document}
	...
	Figure \ref{fig:cam_calib_points} illustrates the triangulation of the key points $C$, $T$ and $L$, a process that yields three corresponding view vectors $v_C$, $v_T$ and $v_L$.
